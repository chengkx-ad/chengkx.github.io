...
input_file = "./datas/input.txt"
output_txt_file = "./datas/output.txt"
output_word_json_file = "./datas/output_word.json"
output_txt_file_sorted = "./datas/output2.txt"
output_word_count_txt = "./datas/word_count.txt"

count_word_frequency(input_file, output_txt_file, output_word_json_file, output_txt_file_sorted, output_word_count_txt)

# 读取单词频率数据
words = []
with open('./datas/output.txt', 'r', encoding='utf-8') as file:
    for line in file:
